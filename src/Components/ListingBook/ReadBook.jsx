                ...
                readBook.map(book => <div key={book.bookId}>
                    <div className='flex flex-col md:flex-row gap-9 mt-10 '>
                        ...
                        <div>
                            ...
                            <div className='text-[#13131360] mb-4 flex items-center gap-6'>
                            ...
                            <div className='flex items-center gap-6'>
                                <div className='px-5 py-3 rounded-full bg-[#328EFF15]'>
                                    <p className='text-[#328EFF]'>Category: {book.category}</p>
                                </div>
                                <div className='px-5 py-3 rounded-full bg-[#FFAC3315]'>
                                    <p className='text-[#FFAC33]'>Rating: {book.rating}</p>
                                </div>

                                <div className='px-5 py-3 rounded-full bg-[#23BE0A]'>
